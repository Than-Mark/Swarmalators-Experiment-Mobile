...
class ChiralActiveMatterNonreciprocalReact(ChiralActiveMatter):
    def __init__(self, strengthLambda: float, 
        ...
        if d0Distribution == "uniform":
            self.distanceD0 = np.random.uniform(distanceD0Mean - distanceD0Std / 2, distanceD0Mean + distanceD0Std / 2, size=agentsNum)
            assert distanceD0Mean - distanceD0Std / 2 >= 0, "distanceD0Mean - distanceD0Std / 2 must be greater than 0"
    ...
    def __str__(self) -> str:
        ...
        name =  (
            ...
            f"_{self.distanceD0Mean:.2f}_{self.distanceD0Std:.2f}"
            f"_{self.randomSeed}"
        )
