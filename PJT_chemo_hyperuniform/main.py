...
class ChemotacticLotkaVolterraOld(PatternFormation):
    def __init__(self, 
    ...
    def productC1(self):
        return self._product_c(
            ...
            productRateK0=self.k1 * self.c1 - self.k2 * self.c1 * self.c2
        )
    ...
    def productC2(self):
        return self._product_c(
            cellNumInLine=self.cellNumInLine, 
            ocsiIdx=self.temp["ocsiIdx"][self.halfAgentsNum:],
            productRateK0=self.k3 * self.c2 * self.c1 - self.k4 * self.c2
        )
    ...
    def __str__(self) -> str:
        ...
        name =  (
            ...
            f"_K3{self.k3:.3f}_K4{self.k4:.3f}"
            f"_a1{self.chemoAlpha1:.1f}_a2{self.chemoAlpha2:.1f}"
            f"_{'fieldDrive' if self.fieldDrive else 'noDrive'}"
